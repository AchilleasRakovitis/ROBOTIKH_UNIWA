function q=inv_kin_2l_straight(xd,yd)
%Τροποποιημένη έκδοση του inv_kin_2l.
...
q_pano=[theta1_pano theta2_pano]*180/pi;
%*********************************
...
q_kato=[theta1_kato theta2_kato]*180/pi;
%*********************************


if CURRENT_Q(2)<0  
    q=[q_pano(1) q_pano(2)]; %q1,q2
else
    q=[q_kato(1) q_kato(2)]; %q1,q2
end