function moveworldxs(wx_mov)
% -> moveworldxs(ww_mov)
%Συνάρτηση κίνησης, ΣΕ ΕΥΘΕΙΑ ΤΡΟΧΙΑ, κατά τον άξονα Χ του αδρανειακού πλαισίου της Βάσης
%Όρισμα 1: (tw_mov) -> απόσταση κατά x-axis (world)
